...
##Style of df
df_coordinators = df_coordinators.style.set_properties(**{'background-color': 'lavenderblush',
                                                          'color': 'black',
                                                          'border-color': 'white'})
...
c = alt.Chart(df_contribution_per_year).mark_bar(barSize=200).encode(
  x = 'year',
  y = 'ecContribution'
)
st.altair_chart(c, use_container_width=False)

c1 = alt.Chart(df_contribution_per_year).mark_bar().encode(
